...
//       title: "Fresh & Local",
//       description: "We source 90% of our ingredients from local Zimbabwean farmers and suppliers.",
//       color: "from-emerald-400 to-teal-500",
//       bgColor: "bg-emerald-50",
//       features: ["Local produce", "Daily fresh", "Seasonal ingredients"]
//     },
//     {
//       icon: <Heart className="w-8 h-8" />,
//       title: "Made with Love",
//       description: "Every product is crafted with the same care we'd use for our own family.",
//       color: "from-pink-400 to-rose-500",
//       bgColor: "bg-pink-50",
//       features: ["Family recipes", "Handcrafted", "Personal touch"]
//     },
//     {
//       icon: <Shield className="w-8 h-8" />,
//       title: "Quality Guarantee",
//       description: "We never compromise on quality. If you're not happy, we're not happy.",
//       color: "from-blue-400 to-indigo-500",
//       bgColor: "bg-blue-50",
//       features: ["Quality ingredients", "Consistent taste", "Satisfaction guarantee"]
//     },
//     {
...
//       features: ["Local employment", "Community events", "Charity support"]
//     },
//     {
//       icon: <Zap className="w-8 h-8" />,
//       title: "Innovation",
//       description: "Blending traditional recipes with modern techniques and flavors.",
//       color: "from-amber-400 to-orange-500",
//       bgColor: "bg-amber-50",
//       features: ["Creative designs", "Modern flavors", "Traditional roots"]
//     },
//     {
//       icon: <Star className="w-8 h-8" />,
//       title: "Excellence",
//       description: "Committed to excellence in every detail, from ingredients to presentation.",
//       color: "from-yellow-400 to-amber-500",
//       bgColor: "bg-yellow-50",
//       features: ["Attention to detail", "Professional standards", "Award winning"]
//     }
//   ];

//   return (
//     <section className="py-16 lg:py-24 bg-gradient-to-br from-[#bfdfd5] to-[#e3fdf5]">
//       <div className="container mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="text-center mb-16">
//           <div className="inline-flex items-center gap-2 bg-[#A7F3D0]/20 text-[#0ca0f5f8] px-4 py-2 rounded-full text-sm font-semibold mb-4">
//             <Star className="w-4 h-4 fill-current" />
//             Our Core Values
//           </div>
//           <h2 className="text-4xl lg:text-5xl font-bold text-[#0ca0f5f8] mb-4">
//             What Makes Us
//             <span className="block text-[#0ca0f5f8]">Special</span>
//           </h2>
//           <p className="text-lg text-[#0ca0f5f8]/70 max-w-3xl mx-auto">
//             These values guide everything we do, from selecting ingredients to serving our customers.
//             They are the foundation of our success and your satisfaction.
//           </p>
//         </div>
...
//                 {/* Content */}
//                 <h3 className="text-xl lg:text-2xl font-bold text-[#0ca0f5f8] mb-4">
//                   {value.title}
//                 </h3>

//                 <p className="text-[#0ca0f5f8]/80 leading-relaxed mb-6">
//                   {value.description}
//                 </p>
...
//                     <li key={featureIndex} className="flex items-center gap-2 text-sm text-[#0ca0f5f8]/70">
...
//         {/* Mission Statement */}
//         <div className="mt-16 bg-gradient-to-r from-[#0ca0f5f8] to-[#0ca0f5f8] rounded-2xl p-8 lg:p-12 text-center text-white">
//           <div className="max-w-4xl mx-auto">
//             <h3 className="text-2xl lg:text-3xl font-bold mb-6">
//               Our Sweet Mission
//             </h3>
//             <p className="text-lg lg:text-xl leading-relaxed opacity-95">
//               "To create unforgettable moments through the art of baking, using the finest local ingredients,
//               traditional family recipes, and a whole lot of love. We're not just baking treats;
//               we're crafting memories that sweeten life's most precious moments."
//             </p>
//             <div className="flex items-center justify-center gap-2 mt-6 text-amber-200">
//               <span className="text-2xl">🇿🇼</span>
//               <span className="font-semibold">Proudly Serving Zimbabwe Since 2009</span>
//             </div>
//           </div>
//         </div>
//       </div>
