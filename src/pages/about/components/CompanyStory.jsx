...
//               <div className="aspect-[4/5] bg-gradient-to-br from-amber-200 to-orange-300 flex items-center justify-center">
...
//             <div className="absolute -bottom-4 lg:-bottom-6 -left-2 lg:-left-6 bg-white rounded-xl lg:rounded-2xl p-3 lg:p-6 shadow-xl border border-amber-100 transform scale-75 lg:scale-100">
//               <div className="text-center">
//                 <div className="text-xl lg:text-2xl font-bold text-[#8B4513] mb-1">15+</div>
//                 <div className="text-xs text-amber-700">Years of Excellence</div>
//               </div>
//             </div>
            
//             <div className="absolute -top-4 lg:-top-6 -right-2 lg:-right-6 bg-[#EA580C] text-white rounded-xl lg:rounded-2xl p-3 lg:p-6 shadow-xl transform scale-75 lg:scale-100">
//               <div className="text-center">
...
//               <div className="inline-flex items-center gap-2 bg-[#8B4513]/10 text-[#8B4513] px-3 lg:px-4 py-1 lg:py-2 rounded-full text-xs lg:text-sm font-semibold mb-3 lg:mb-4">
//                 <Heart className="w-3 h-3 lg:w-4 lg:h-4 fill-current" />
//                 Our Sweet Journey
//               </div>
              
//               <h2 className="text-3xl lg:text-5xl font-bold text-[#8B4513] mb-4 lg:mb-6 leading-tight">
//                 Baking Memories
//                 <span className="block text-[#EA580C] text-2xl lg:text-5xl">Since 2009</span>
//               </h2>
//             </div>

//             <div className="space-y-4 lg:space-y-6 text-[#8B4513]/90">
//               <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/50 rounded-xl">
//                 <div className="flex items-center gap-3 mb-2 sm:mb-0">
//                   <Clock className="w-5 h-5 lg:w-6 lg:h-6 text-[#EA580C] flex-shrink-0" />
...
//                     What started as a small family bakery in downtown Harare has blossomed into 
//                     Zimbabwe's most beloved confectionery. Sarah's passion for baking, passed down 
//                     through generations, found its home in our humble kitchen.
//                   </p>
//                 </div>
//               </div>
...
//               <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/50 rounded-xl">
//                 <div className="flex items-center gap-3 mb-2 sm:mb-0">
//                   <Target className="w-5 h-5 lg:w-6 lg:h-6 text-[#EA580C] flex-shrink-0" />
...
//                   <p className="leading-relaxed text-sm lg:text-base">
//                     To create unforgettable moments through the art of baking. We believe every 
//                     cake tells a story, every pastry carries love, and every bite should transport 
//                     you to a place of joy and comfort.
//                   </p>
//                 </div>
//               </div>
...
//               <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4 p-3 lg:p-4 bg-white/50 rounded-xl">
//                 <div className="flex items-center gap-3 mb-2 sm:mb-0">
//                   <MapPin className="w-5 h-5 lg:w-6 lg:h-6 text-[#EA580C] flex-shrink-0" />
//                   <h3 className="font-bold text-base lg:text-lg sm:hidden">Zimbabwean Roots</h3>
//                 </div>
//                 <div className="flex-1">
//                   <h3 className="font-bold text-base lg:text-lg mb-2 hidden sm:block">Zimbabwean Roots</h3>
//                   <p className="leading-relaxed text-sm lg:text-base">
//                     Proudly using local ingredients from Zimbabwean farmers. We support our 
//                     community while bringing you the authentic tastes of home with every creation.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               <div className="bg-[#8B4513] text-white px-4 lg:px-6 py-2 lg:py-3 rounded-full font-semibold text-sm lg:text-base text-center">
//                 Family Owned & Operated
//               </div>
//               <div className="bg-[#EA580C] text-white px-4 lg:px-6 py-2 lg:py-3 rounded-full font-semibold text-sm lg:text-base text-center">
...
//               <div className="text-center">
//                 <div className="text-2xl font-bold text-[#8B4513] mb-1">15+</div>
//                 <div className="text-xs text-amber-700">Years of Excellence</div>
//               </div>
//               <div className="text-center">
//                 <div className="text-2xl font-bold text-[#EA580C] mb-1">50K+</div>
//                 <div className="text-xs text-amber-700">Happy Customers</div>
//               </div>
//             </div>
//           </div>
//         </div>
